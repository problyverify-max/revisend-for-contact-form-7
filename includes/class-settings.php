...
class CF7RB_Settings {
	...
	public static function add_panel( $panels ) {
		$panels['cf7rb-panel'] = array(
			'title'    => __( 'Revisend', 'revisend-for-contact-form-7' ),
	...
	public static function render_panel( $contact_form ) {
		...
		?>
		<h2><?php echo esc_html__( 'Revisend for Contact Form 7', 'revisend-for-contact-form-7' ); ?></h2>

		<fieldset>
			<legend><?php echo esc_html__( 'Confirmation step', 'revisend-for-contact-form-7' ); ?></legend>

			<table class="form-table" role="presentation">
				<tbody>
					<tr>
						<th scope="row">
							<?php echo esc_html__( 'Enable review step', 'revisend-for-contact-form-7' ); ?>
						</th>
						<td>
							<label for="cf7rb-enable">
								<input
									...
									<?php checked( $enabled ); ?>
								/>
								<?php echo esc_html__( 'Show a review step before this form is sent', 'revisend-for-contact-form-7' ); ?>
							</label>

							<p class="description">
								<?php echo esc_html__( 'Visitors will see a summary of their input and must confirm before the form is submitted.', 'revisend-for-contact-form-7' ); ?>
							</p>
						</td>
					</tr>
				</tbody>
